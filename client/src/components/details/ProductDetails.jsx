import { Typography,Box,styled, TableBody, TableRow, Table, TableCell} from "@mui/material";
    ...
    return(
        <>
            ...
            <Typography>
                ...
                <Box component="span" stye={{color:'388E3C'}}>{product.price.discount}</Box>
            </Typography>
            <Typography>
                Available Offers
            </Typography>
            <SmallText>
                ...
                <Typography><StyledBadge/>Sign up for Fipkart Pay Later and get Flipkart Gift Card worth ₹100*KnowMore</Typography>
